...
var FourierDiagram = (function () {
	...
	FourierDiagram.prototype.bbox = function () {
		...
		return "" + (x - (length * this.margin) / 2) + " " + (y - (length * this.margin) / 2) + " " + length * this.margin + " " + length * this.margin;
	};
   ...
   <radialGradient id="GradientPad"
      ...
      <radialGradient id="GradientRepeat"
            cx="0.5" cy="0.5" r="0.4" fx="0.75" fy="0.75"
            spreadMethod="repeat">
        <stop offset="0%" stop-color="#45dcb900"/>
        <stop offset="10%" stop-color="#c921ff82"/>
        <stop offset="20%" stop-color="#c921ff0"/>
        <stop offset="100%" stop-color="#45b9dc00"/>
      </radialGradient>
      <radialGradient id="GradientReflect"
            cx="0.5" cy="0.5" r="0.4" fx="0.75" fy="0.75"
            spreadMethod="reflect">
            <stop offset="0%" stop-color="#45dcb900"/>
        <stop offset="10%" stop-color="#99999982"/>
        <stop offset="90%" stop-color="#c921ff00"/>
        <stop offset="100%" stop-color="#c921ff00"/>
      </radialGradient>
   <marker id="arrow" viewBox="0 0 10 10" refX="5" refY="5"
   markerWidth="10" markerHeight="10"
   orient="auto-start-reverse" stroke="teal">
 <path d="M 0 0 L 10 5 L 0 10 z" />
		...
		// traceline.setAttribute("fill", "url(#GradientReflect)");
	...
	FourierDiagram.prototype.animate = function (time) {
		...
		this.svgPolyLine.setAttribute("fill", "url(#Gradient2)");
